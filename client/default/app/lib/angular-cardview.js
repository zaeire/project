 ...
 *
 */
angular.module("website", []).directive("cardView", ["$injector",
  function($injector) {
    return {
      restrict: "EA",
      scope: {
      ...
      link: function(scope, element, attrs) {
        ...
        var onUpdateContent = override ? onUpdateContentWrapper : function(el, data) {
          ...
          var childScope = angular.extend(scope.$parent.$new(), {
            card: data
          });
          ...
          scope.index = reverse ? cardView.page !== 0 ? cardView.pageCount - cardView.page : 0 : cardView.page;
